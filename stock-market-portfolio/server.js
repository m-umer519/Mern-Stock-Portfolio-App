...
mongoose.connect("mongodb+srv://islamabad:islamabad1122@cluster0.hxcwsuw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0", {
...
app.post("/api/watchlist",async(req,res)=>{
    ...
    try{
        ...
        await stock.save();
        res.json({message:"Stock Saved to Wishlist Sussesfully"});
    }
 ...
 app.post("/api/uploadArray",async(req,res)=>{
    ...
    try{
        ...
        if(Array.isArray(stockData)){
            ...
            res.json({message:"Array of stocks inserted into Watchlist sussesfully"});


        }
        else{

            res.status(400).json({message:"It is expecting Array to be inserted"});
...
app.post("/api/seed",async(req,res)=>{
    ...
    try{
//insert stock data in the stocks collection
await Stock.insertMany(stockData);
res.json({message:"Stocks Inserted Sussesfully"});
    }
